...
#setwd("D:\\Bioinformatics\\package")
#install.packages("org.Hs.eg.db_3.20.0.tar.gz",repos=NULL, type="source")
...
rt=read.table("interGenes.txt", header=F, sep="\t", check.names=F)     #读取差异分析的结果文件
